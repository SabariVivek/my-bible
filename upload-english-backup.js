...
async function uploadBook(bookName) {
  try {
    ...
    const filePath = path.join(__dirname, 'backup-bible', 'english', testamentPath, `${fileName}.js`);
...
async function main() {
  console.log('🚀 Starting English Bible Upload (FROM BACKUP)\n');
  ...
  console.log('📤 Uploading new English verses from backup-bible...\n');
